...
public class IOUtilTest {
    ...
    public void testIsURIAvaliable() {
        assertTrue(IOUtil.isURIAvailable("file://com/rapiddweller/commons/names.csv"));
        assertTrue(IOUtil.isURIAvailable("file:com/rapiddweller/commons/names.csv"));
        assertTrue(IOUtil.isURIAvailable("com/rapiddweller/commons/names.csv"));
        assertFalse(IOUtil.isURIAvailable("com/rapiddweller/commons/not.an.existing.file"));
    }

	@Test    
    public void testGetContentOfURI() throws IOException {
        assertEquals("Alice,Bob\r\nCharly", IOUtil.getContentOfURI("file:com/rapiddweller/commons/names.csv"));
        assertEquals("Alice,Bob\r\nCharly", IOUtil.getContentOfURI("file://com/rapiddweller/commons/names.csv"));
        assertEquals("Alice,Bob\r\nCharly", IOUtil.getContentOfURI("com/rapiddweller/commons/names.csv"));
    }
    ...
    public void testReadProperties() throws IOException {
        Map<String, String> properties = IOUtil.readProperties("com/rapiddweller/commons/test.properties");
