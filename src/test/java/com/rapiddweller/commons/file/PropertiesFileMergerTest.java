...
import com.rapiddweller.commons.collection.TreeBuilder;
...
public class PropertiesFileMergerTest {
	...
	private static final String FILE_XML_FILENAME = "src/test/resources/com/rapiddweller/commons/xml/properties.xml";
	private static final String MERGED_SIMPLE_XML_FILENAME = "target/mergedSimple.xml";
	private static final URL JAR_URL;
	
	private static final String COMPLEX_XML_FILE1 = "src/test/resources/com/rapiddweller/commons/xml/complexProps1.xml";
	private static final String COMPLEX_XML_FILE2 = "src/test/resources/com/rapiddweller/commons/xml/complexProps2.xml";
	private static final String MERGED_COMPLEX_XML_FILE = "target/mergedComplex.xml";
	
	static {
		try {
			JAR_URL = new URL("file:src/test/resources/com/rapiddweller/commons/file/JarWithProperties.jar");
