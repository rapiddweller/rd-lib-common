...
public class ObservableFactoryTest {
	...
	public void testToString() {
		...
		String expectedString = "com.rapiddweller.commons.bean.IPerson{age=23, name=Alice}";
		String validAlternative = "com.rapiddweller.commons.bean.IPerson{name=Alice, age=23}";
