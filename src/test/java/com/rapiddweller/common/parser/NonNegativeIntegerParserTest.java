...
/**
 * Tests the {@link NonNegativeIntegerParser}.<br/><br/>
 * Created: 09.12.2021 18:32:35
 * @author Volker Bergmann
 * @since 2.0.0
 */
public class NonNegativeIntegerParserTest {

  NonNegativeIntegerParser p = new NonNegativeIntegerParser();

  @Test
  public void testOK() {
    assertEquals(123, (int) p.parse("123"));
    assertEquals(0, (int) p.parse("0"));
  }
