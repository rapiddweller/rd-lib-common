...
/**
 * Tests the {@link PositiveIntegerParserTest}.<br/><br/>
 * Created: 09.12.2021 18:37:48
 * @author Volker Bergmann
 * @since 2.0.0
 */
public class PositiveIntegerParserTest {

  PositiveIntegerParser p = new PositiveIntegerParser();

  @Test
  public void testOK() {
    assertEquals(123, (int) p.parse("123"));
    assertEquals(1, (int) p.parse("1"));
  }
