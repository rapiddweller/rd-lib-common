...
public class FormatterTest {
    ...
    public void testFormatPercentage() {
        assertEquals("1,000.0%", Formatter.formatPercentage(10.0));
    }

    @Test
    public void testFormatPercentalChange() {
        assertEquals("+1,000.0%", Formatter.formatPercentalChange(10.0));
        assertEquals("+1,000.0%", Formatter.formatPercentalChange(10.0, 1));
    }

    @Test
    public void testFormat() {
        assertEquals("10.00", Formatter.format(10.0));
        assertEquals("NaN", Formatter.format(Double.NaN));
        assertEquals("10", Formatter.format(10.0, 3));
        assertEquals("10.00", Formatter.format(10.0, new Locale("en")));
    ...
    public void testFormatLocal() {
        ...
        assertEquals("Jan 1, 1970",
                Formatter.formatLocal(Date.from(atStartOfDayResult.atZone(ZoneId.systemDefault()).toInstant())));
    }
