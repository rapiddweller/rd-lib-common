...
public class NotAccessorTest {
    ...
    public void testEquals() {
        ...
        ConditionalAccessor<Object, Boolean> trueAccessor1 = new ConditionalAccessor<Object, Boolean>(null, null, null);
        ConditionalAccessor<Object, Boolean> trueAccessor2 = new ConditionalAccessor<Object, Boolean>(condition2,
                trueAccessor1, new ConditionalAccessor<Object, Boolean>(null, null, null));
        ConditionalAccessor<Object, Boolean> condition3 = new ConditionalAccessor<Object, Boolean>(null, null, null);
        ConditionalAccessor<Object, Boolean> trueAccessor3 = new ConditionalAccessor<Object, Boolean>(null, null, null);
        assertFalse((new NotAccessor<Object>(
                new ConditionalAccessor<Object, Boolean>(condition1, trueAccessor2, new ConditionalAccessor<Object, Boolean>(
                        condition3, trueAccessor3, new ConditionalAccessor<Object, Boolean>(null, null, null))))).equals("o"));
    }
