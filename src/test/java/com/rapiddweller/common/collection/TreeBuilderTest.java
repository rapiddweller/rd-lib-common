...
public class TreeBuilderTest {
	...
	public void testParseSimpleXML() throws IOException {
		...
		TreeBuilder actual = TreeBuilder.parseXML(new FileInputStream("src/test/resources/com/rapiddweller/common/xml/properties.xml"));
		assertEquals(expected, actual);
	}

	@Test
	public void testParseComplexXML() throws IOException {
		TreeBuilder tree = TreeBuilder.parseXML(new FileInputStream("src/test/resources/com/rapiddweller/common/xml/complexProps1.xml"));
