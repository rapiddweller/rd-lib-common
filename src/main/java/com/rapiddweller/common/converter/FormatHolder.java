...
/**
 * Holds format strings for date and number objects.<br/><br/>
...
public abstract class FormatHolder implements Patterns {
  ...
  protected FormatHolder(String nullString) {
    this(nullString, DEFAULT_DATE_PATTERN, DEFAULT_TIMESTAMP_PATTERN);
  }

  protected FormatHolder(String nullString, String datePattern, String timestampPattern) {
