...
import com.rapiddweller.commons.converter.PercentageFormatter;
...
public class Formatter {
	...
	private static ResourceBundle getBundle() {
		return PropertyResourceBundle.getBundle("com/rapiddweller/commons/formatter", Locale.getDefault());
	}
